#!/bin/bash
#
# Developed by Fred Weinhaus 11/11/2014 .......... revised 1/4/2019
#
# ------------------------------------------------------------------------------
# 
# Licensing:
...
# [-o opacity] [-E] [-D directory] infile bgfile outfile
#
# USAGE: tshirt [-help|-h]
#
# OPTIONS:
...
#echo "scale=$scale; ws=$ws; hs=$hs; wd=$wd; ht=$ht;"
...
if [ "$coords" != "" ]; then
	...
	wo=`convert xc: -format "%[fx:max($xo4-$xo1,$xo3-$xo2)+1]" info:`
